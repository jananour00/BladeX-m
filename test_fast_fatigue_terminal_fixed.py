...
Usage: python test_fast_fatigue_terminal_fixed.py [save|test|demo]
"""

import sys
import numpy as np
from integrate_fast_fatigue_fixed import (
...
if __name__ == '__main__':
    ...
    if mode == 'save':
        ...
        save_complete_model()
        print("\n✅ Run 'python test_fast_fatigue_terminal_fixed.py test' to test.")
        ...
        print(f"\n❓ Unknown mode: {mode}")
        print("   Usage: python test_fast_fatigue_terminal_fixed.py [save|test|demo]")
